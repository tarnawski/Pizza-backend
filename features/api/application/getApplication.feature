Feature: Show information about application
  In order to have possibility to show application details
  As a login user
  I need to be able to get information about my application
  ...
  Background:
    ...
    Given There are the following applications:
      ...
      | 1  | Application_1  | Short deccription number 1  | http://www.demo1.pl | true  | 1      |
      | 2  | Application_2  | Short deccription number 2  | http://www.demo2.pl | false | 2      |
      | 3  | Application_3  | Short deccription number 3  | http://www.demo3.pl | true  | 2      |
  ...
  Scenario: Get application details
    ...
    When I send a GET request to "/api/application"
    ...
    """
    {
      "id": @integer@,
      "name": "Application_1",
      "description": "Short deccription number 1",
      "homepage": "http://www.demo1.pl",
      "demo": true,
      "create_date": "@string@"
    }
    """
