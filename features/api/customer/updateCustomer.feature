Feature: Update customer
  In order to have possibility change customer data belongs to application
  As a login user
  I need to be able to update information about customer
  ...
  Scenario: Update customer
    ...
    When I send a PUT request to "/api/customers/1" with body:
    """
    {
      "first_name": "Anna",
